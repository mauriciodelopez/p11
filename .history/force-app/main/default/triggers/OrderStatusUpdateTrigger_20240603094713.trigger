...
// La class de test OrderProductValidator a //Pas d'appel de methode hasproducts dans le for et faire une seule class pour handler et la methode hasproducts
