...
//Le  OrderTrigger est défini sur l'objet Order et il se déclenche avant toute mise à jour. Il appelle la méthode beforeUpdate de la classe OrderTriggerHandler.
