...
// La class de test OrderProductValidator enlever l'appel de la methode hasProducts dans le boucle for, rappel toi Pas d'appel de methode hasproducts dans le for 
//Faire une seule class que englobe les class en orderTriggerHandler & OrderProductValidator, c'est n'est pas obligatoire  pour handler et la methode hasproducts
